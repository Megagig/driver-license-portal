...
const Footer = () => {
    ...
    const linkStyle = "flex font-thin hover:translate-x-1  transition-all hover:text-[#15803D] duration-100 text-[#093A51] gap-2"
    const linkheadStyle = "font-thin text-lg mb-4 text-[#22D665]"
