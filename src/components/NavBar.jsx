  ...
  return (
    ...
    >
      ...
      {isMobile ? (
        ...
        <span className="">{isOpen ? <FiChevronUp /> : <FiChevronDown />}</span>
      )}
    </div>
  );
};
      ...
      <div className="container mx-auto flex justify-center items-center">
        <div className="hidden md:flex">
          ...
          >
            ...
            {isDropdownOpen && <DropDownMenu menuArray={applications} />}
          </div>
          <div
            className="relative px-6 py-4 hover:bg-green-700"
      ...
      {isMenuOpen && (
        <div className="absolute top-0 right-0 z-20 h-full w-full md:hidden bg-[#3d4249]">
          ...
          <div className="flex flex-col px-6 py-4 mt-20 divide-y divide-solid divide-neutral-600">
            <Link to="/" className="text-white px-6 py-4  transition-colors">
              Home
            </Link>
            <div
            ...
            <Link to="/faq" className="text-white px-6 py-4 transition-colors">
              FAQ
            </Link>
            <div
              className="relative px-6 py-4"
