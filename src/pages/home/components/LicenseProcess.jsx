...
const LicenseProcess = () => {
    return (
        <section className='w-full p-4 md:p-10 lg:p-20 flex-col lg:flex-row flex '>
            ...
            <div className='bg-white flex-1 flex p-6 xl:p-12 items-center gap-6 rounded-lg'>
            ...
            <div className='md:bg-white flex-1 flex p-6 xl:p-12 bg-[#d5ffe4] items-center gap-6 rounded-lg'>
            ...
            <div className='bg- flex-1 flex p-6 xl:p-12 items-center gap-6 bg-white md:bg-[#d5ffe4] rounded-lg'>
