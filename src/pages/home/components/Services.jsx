    ...
    return (
        <section className='bg-[#f2f2f2] w-full px-6 md:px-8 lg:px-10 py-16  md:py-20 xl:px-16 flex flex-col'>
            ...
            <div className='xl:px-20 grid md:grid-cols-2 lg:grid-cols-3 mt-12 lg:mt-20 gap-10 lg:gap-8'>
                ...
                <div className='shadow-lg hover:bg-green-400 hover:shadow-xl  hover:scale-110 hover:text-white  border-[#F4F4F4] border-t-[#4cffff] border-t-[16px] border bg-[#d5ffe4] flex flex-col rounded-xl p-4 md:p-10 gap-4 md:gap-7 items-start '>
                  <div style={{backgroundImage :`url(${print})`}} className={`w-10 h-10 md:w-16 md:h-16 rounded-lg bg-contain self-center`}></div>
                    <p className='hover:translate-z-28   font-semibold text-base md:text-[23px]/[26.4px] text-wrap self-center'>
